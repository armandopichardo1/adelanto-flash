...
export default function AdvanceRequestFlow() {
  ...
  const sliderMax = smartRefill.canRefill
    ? smartRefill.remainingAvailable
    : advanceLimit.maxAdvanceAmount;
  ...
  const fee =
    "incrementalFee" in advanceDetails
      ? advanceDetails.incrementalFee
      : advanceDetails.fee;
  const totalToDeduct =
    "incrementalTotalToDeduct" in advanceDetails
  ...
  if (step === 1) {
    return (
      <div className="min-h-screen bg-surface-container-low">
        <StepHeader
          title={smartRefill.canRefill ? "Recargar Adelanto" : "Solicitar Adelanto"}
        ...
        <main className="container mx-auto px-4 py-8 max-w-lg">
          <div className="bg-surface-container-lowest rounded-3xl shadow-card p-8">
            <div className="text-center mb-2">
              ...
              <h2 className="font-headline text-xl font-bold text-foreground mt-2">
            ...
            <div className="bg-surface-container-low rounded-2xl p-4 space-y-3 mb-6">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-semibold text-foreground">{formatDOP(fee)}</span>
              </div>
            </div>
          ...
          <div className="bg-surface-container-lowest rounded-2xl shadow-card p-6 mb-6">
            <div className="flex items-start gap-3">
              ...
              <label htmlFor="terms" className="text-sm text-muted-foreground leading-relaxed cursor-pointer">
                Autorizo el descuento automático de mi salario para cubrir el monto del servicio de
                adelanto de nómina provisto por <strong className="text-foreground">Adelanto Ya</strong>.
                Entiendo que esto no constituye un préstamo ni genera intereses.
              </label>
            </div>
          </div>
  ...
  return (
    <div className="min-h-screen bg-surface-container-low flex items-center justify-center">
      <main className="container mx-auto px-4 py-12 max-w-lg text-center">
        ...
        {/* Transaction Details */}
        <div className="bg-surface-container-lowest rounded-2xl shadow-card p-6 mb-8 text-left">
        ...
        <Button variant="default" size="lg" className="w-full" onClick={() => navigate("/employee")}>
          Volver al Inicio
        </Button>
      </main>
    </div>
